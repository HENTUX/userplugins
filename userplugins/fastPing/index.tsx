...
const settings = definePluginSettings({
    trailingSpace: {
        ...
        description: t("╪ú╪╢┘ü ┘à╪│╪º┘ü╪⌐ ╪¿╪╣╪» ╪º┘ä╪Ñ╪┤╪º╪▒╪⌐ ╪╣┘å╪» ╪Ñ╪»╪▒╪º╪¼┘ç╪º", "Add a space after the mention once inserted"),
        default: true,
    },
});

// ΓöÇΓöÇ Popover state (plain DOM, no React needed for a single floating button) ΓöÇΓöÇ
