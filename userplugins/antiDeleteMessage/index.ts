...
const settings = definePluginSettings({
    enabled: {
        ...
        description: t("╪¬┘ü╪╣┘è┘ä ╪º╪│╪¬╪╣╪º╪»╪⌐ ╪º┘ä╪▒╪│╪º╪ª┘ä ╪¬┘ä┘é╪º╪ª┘è╪º┘ï", "Enable automatic message restoration"),
        default: true,
    },
    dmProtection: {
        type: OptionType.BOOLEAN,
        description: t("╪¡┘à╪º┘è╪⌐ ╪º┘ä╪▒╪│╪º╪ª┘ä ╪º┘ä╪«╪º╪╡╪⌐ ╪ú┘è╪╢╪º┘ï (┘ä╪º ╪º┘ä╪│┘è╪▒┘ü╪▒╪º╪¬ ┘ü┘é╪╖)", "Also protect DMs (not just servers)"),
        default: false,
    },
    maxCacheSize: {
        type: OptionType.NUMBER,
        description: t("╪ú┘é╪╡┘ë ╪╣╪»╪» ╪▒╪│╪º╪ª┘ä ┘è┘Å╪¡╪¬┘ü╪╕ ╪¿┘ç╪º ┘ü┘è ╪º┘ä╪░╪º┘â╪▒╪⌐ ╪º┘ä┘à╪ñ┘é╪¬╪⌐", "Maximum number of messages kept in cache"),
        default: 500,
    },
    serverBlacklist: {
        type: OptionType.STRING,
        description: t("┘à╪╣╪▒┘æ┘ü╪º╪¬ ╪º┘ä╪│┘è╪▒┘ü╪▒╪º╪¬ ╪º┘ä┘à┘Å╪¬╪¼╪º┘ç┘Ä┘ä╪⌐ (┘à┘ü╪╡┘ê┘ä╪⌐ ╪¿┘ü┘ê╪º╪╡┘ä). ╪º┘ä╪▒╪│╪º╪ª┘ä ╪º┘ä┘à┘Å╪▒╪│┘Ä┘ä╪⌐ ┘ü┘è┘ç╪º ┘ä┘å ┘è┘Å╪╣╪º╪» ╪Ñ╪▒╪│╪º┘ä┘ç╪º.", "Server IDs to ignore (comma-separated). Messages sent in these servers will NOT be resent."),
        default: "",
...
// In-memory cache ΓÇö mirror of IndexedDB for fast access
