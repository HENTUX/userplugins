...
const settings = definePluginSettings({
    autoStopMinutes: {
        ...
        options: [
            ...
            { label: "Never ΓÇö keep following until I stop it myself", value: 0 },
        ],
...
// ΓöÇΓöÇ Etat global ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Timer d'inactivite : unfollow auto apres X min sans utilisation ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
// autoStopMinutes = 0 means "never" ΓÇö no timer is armed at all.
function resetInactivityTimer() {
    ...
    inactivityTimer = setTimeout(() => {
        if (followedId) {
            Toasts.show({ message: t(`╪«┘à┘ê┘ä ${minutes} ╪»┘é┘è┘é╪⌐ ΓÇö ╪Ñ┘è┘é╪º┘ü ┘à╪¬╪º╪¿╪╣╪⌐ ${followedName}`, `Inactive for ${minutes}min ΓÇö stopped following ${followedName}`), type: Toasts.Type.FAILURE, id: Toasts.genId() });
            unfollow();
        }
    }, minutes * 60 * 1000);
}
...
// ΓöÇΓöÇ Listener voix ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        if (newCh !== followedChannel) {
            ...
            if (newCh) {
                ...
                if (settings.store.notifyOnAutoJoin) {
                    Toasts.show({ message: t(`╪º┘å╪¬┘é┘ä╪¬ ┘à╪╣ ${followedName}`, `Moved with ${followedName}`), type: Toasts.Type.MESSAGE, id: Toasts.genId() });
                }
            } else if (settings.store.leaveWhenUserLeaves && prevCh) {
                // followed user left voice ΓåÆ leave too
                leaveChannel();
            }
        }
    }
...
// ΓöÇΓöÇ Follow / Unfollow ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function joinFollowed() {
    if (!followedChannel) {
        Toasts.show({ message: t(`${followedName} ┘ä┘è╪│ ┘ü┘è ┘é┘å╪º╪⌐ ╪╡┘ê╪¬┘è╪⌐`, `${followedName} is not in a voice channel`), type: Toasts.Type.FAILURE, id: Toasts.genId() });
        return;
    }
    joinChannel(followedChannel);
    resetInactivityTimer();
...
// ΓöÇΓöÇ Icone coeur ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Bouton HeaderBar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function FollowHeaderButton() {
    ...
    return (
        <HeaderBarButton
            ...
            tooltip={t(`${followedName} ΓÇö ┘å┘é╪▒: ╪º┘å╪╢┘à╪º┘à ┘ä┘ä╪╡┘ê╪¬ | ┘å┘é╪▒ ┘è┘à┘è┘å: ╪Ñ┘ä╪║╪º╪í ╪º┘ä┘à╪¬╪º╪¿╪╣╪⌐`, `${followedName} ΓÇö Click: join voice | Right-click: unfollow`)}
            onClick={handleClick}
...
// ΓöÇΓöÇ Context menu ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const ctxPatch: NavContextMenuPatchCallback = (children, props) => {
    ...
    children.push(
        <Menu.MenuCheckboxItem
            id="follow-user-ctx"
            label={isFollowed ? t("╪Ñ┘ä╪║╪º╪í ┘à╪¬╪º╪¿╪╣╪⌐ ╪º┘ä┘à╪│╪¬╪«╪»┘à", "Unfollow User") : t("┘à╪¬╪º╪¿╪╣╪⌐ ╪º┘ä┘à╪│╪¬╪«╪»┘à", "Follow User")}
            checked={isFollowed}
...
// ΓöÇΓöÇ Plugin ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
export default definePlugin({
    name: "FollowUser",
    dependencies: ["HeaderBarAPI"],
    description: "Follow a user across voice channels. Right-click a user ΓåÆ Follow User (you join their channel). Choose whether it stops itself after 30 minutes of inactivity or keeps following until you stop it.",
