...
export default definePlugin({
    ...
    description: "Fully customise your screen share: resolution, framerate, bitrate, keyframe interval, HDR and audio ΓÇö with saveable profiles, in a redesigned Esharq panel.",
    ...
    start(): void {
        ...
        addSettingsPanelButton({
            ...
            get tooltipText() { return t("╪Ñ╪╣╪»╪º╪»╪º╪¬ ┘à╪┤╪º╪▒┘â╪⌐ ╪º┘ä╪┤╪º╪┤╪⌐ ┬╖ BetterScreenshare", "Screenshare settings ┬╖ BetterScreenshare"); },
    ...
    toolboxActions: {
        [t("┘ü╪¬╪¡ ╪Ñ╪╣╪»╪º╪»╪º╪¬ ┘à╪┤╪º╪▒┘â╪⌐ ╪º┘ä╪┤╪º╪┤╪⌐", "Open Screenshare Settings")]: openScreenshareModal
    },
    GoLivePanelWrapper,
