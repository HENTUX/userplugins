    ...
    start() {
        ...
        preSendListener = (channelId, messageObj) => {
            ...
            if (found) {
                ...
                if (settings.store.showToastOnDetection) {
                    showToast(t("╪ú┘Å╪▓┘è┘ä╪¬ ┘à╪¡╪º╪▒┘ü ╪º┘ä╪¬╪¬╪¿┘æ╪╣ ╪º┘ä╪«┘ü┘è┘æ╪⌐ ┘à┘å ╪▒╪│╪º┘ä╪¬┘â", "Removed hidden tracking characters from your message"), Toasts.Type.MESSAGE);
                }
            }
        };
        ...
        preEditListener = (channelId, messageId, messageObj) => {
            ...
            if (found) {
                ...
                if (settings.store.showToastOnDetection) {
                    showToast(t("╪ú┘Å╪▓┘è┘ä╪¬ ┘à╪¡╪º╪▒┘ü ╪º┘ä╪¬╪¬╪¿┘æ╪╣ ╪º┘ä╪«┘ü┘è┘æ╪⌐ ┘à┘å ╪¬╪╣╪»┘è┘ä┘â", "Removed hidden tracking characters from your edit"), Toasts.Type.MESSAGE);
                }
            }
        };
        ...
        log("Plugin started");
        showToast(t("┘à┘å╪╕┘æ┘ü ╪º┘ä┘à╪¡╪º╪▒┘ü ╪º┘ä╪«┘ü┘è┘æ╪⌐ ┘à┘Å┘ü╪╣┘Ä┘æ┘ä", "Zero-width sanitizer active"), Toasts.Type.SUCCESS);
    },
