...
const settings = definePluginSettings({
    enabled: {
        ...
        description: t("╪¬┘ü╪╣┘è┘ä ┘à╪¡╪»┘æ╪» ╪º┘ä╪╡┘ê╪¬", "Enable audio limiter"),
        default: false,
        onChange: (v: boolean) => v ? enableAll() : disableAll(),
    },
    maxVolume: {
        type: OptionType.SLIDER,
        description: t("╪ú┘é╪╡┘ë ┘à╪│╪¬┘ê┘ë ╪╡┘ê╪¬ ┘à╪│┘à┘ê╪¡ (╪»┘è╪│┘è╪¿┘ä) ΓÇö ┘è┘Å╪╢╪║╪╖ ┘à╪º ┘ü┘ê┘é┘ç", "Maximum allowed volume (dB) ΓÇö sounds above are compressed"),
    ...
    attack: {
        type: OptionType.SLIDER,
        description: t("╪│╪▒╪╣╪⌐ ╪º┘ä╪º╪│╪¬╪¼╪º╪¿╪⌐ (┘à┘ä┘ä┘è ╪½╪º┘å┘è╪⌐) ΓÇö ╪º┘ä╪ú┘é┘ä = ╪ú╪│╪▒╪╣", "Reaction speed (ms) ΓÇö lower = more reactive"),
...
export default definePlugin({
    name: "AudioLimiter",
    description: "Automatically caps the volume of other users ΓÇö no more screaming or loud noises that pierce your ears.",
