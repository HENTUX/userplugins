...
const settings = definePluginSettings({
    oauthToken: {
        description: "Your SoundCloud OAuth token. Get it from soundcloud.com ΓåÆ F12 DevTools ΓåÆ Application ΓåÆ Cookies ΓåÆ oauth_token.",
        ...
        return (
            <Card>
                ...
                <Paragraph>
                    ...
                    then Application ΓåÆ Cookies ΓåÆ https://soundcloud.com ΓåÆ copy the value of <code>oauth_token</code>.
                </Paragraph>
