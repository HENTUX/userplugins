...
function downloadMemberList() {
    ...
    if (!guildId || !guild || !channelId || !channel) {
        showToast(t("╪¬╪╣╪░┘æ╪▒ ╪¬╪╡╪»┘è╪▒ ┘é╪º╪ª┘à╪⌐ ╪º┘ä╪ú╪╣╪╢╪º╪í: ╪│┘è╪º┘é ╪º┘ä╪«╪º╪»┘à ╪ú┘ê ╪º┘ä┘é┘å╪º╪⌐ ┘à┘ü┘é┘ê╪».", "Failed to export member list: missing guild or channel context."), Toasts.Type.FAILURE);
        return;
    }
...
function MemberListExportButton() {
    return (
        <Tooltip text={t("╪¬┘å╪▓┘è┘ä ┘é╪º╪ª┘à╪⌐ ╪º┘ä╪ú╪╣╪╢╪º╪í", "Download member list as JSON")}>
