...
export const settings = definePluginSettings(
    {
        ...
        autoScanInvites: {
            type: OptionType.BOOLEAN,
            description: "Automatically analyze AtlasXGOD invites in messages",
            default: true
        },
        checkEmbeds: {
            type: OptionType.BOOLEAN,
        ...
        useBuiltinWhitelist: {
            type: OptionType.BOOLEAN,
            description: "Use built-in whitelist (AtlasXGOD, YouTube, GitHub, etc. are skipped from scanning)",
            default: true
        },
        enableBlocklists: {
            type: OptionType.BOOLEAN,
