...
// that share those method names (EmojiStore, permission storesΓÇª). Patching the wrong one
...
// ΓöÇΓöÇ UI ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function RestoreButton() {
    ...
    return (
        <HeaderBarButton
            icon={RestoreIcon}
            tooltip={t("╪¡╪│╪º╪¿ ┘ê┘ç┘à┘è ┘à┘Å┘ü╪╣┘æ┘ä ΓÇö ╪º┘å┘é╪▒ ┘ä╪º╪│╪¬╪╣╪º╪»╪⌐ ╪¡╪│╪º╪¿┘â ╪º┘ä╪¡┘é┘è┘é┘è", "Fake account active ΓÇö click to restore your real account")}
...
const ctxPatch: NavContextMenuPatchCallback = (children, props) => {
    ...
    children.push(
        <Menu.MenuItem
            ...
            label={already
                ? t("╪Ñ╪▓╪º┘ä╪⌐ ┘à┘å ┘à╪¿╪»┘æ┘ä ╪º┘ä╪¡╪│╪º╪¿╪º╪¬ ╪º┘ä┘ê┘ç┘à┘è", "Remove from Fake Switcher")
                : t("╪Ñ╪╢╪º┘ü╪⌐ ╪Ñ┘ä┘ë ┘à╪¿╪»┘æ┘ä ╪º┘ä╪¡╪│╪º╪¿╪º╪¬ ╪º┘ä┘ê┘ç┘à┘è", "Add to Fake Switcher")}
            icon={FakeIcon}
...
export default definePlugin({
    name: "FakeAccount",
    description: "Add users to your account switcher and locally take on their appearance. Purely visual ΓÇö only you see it; your real account and token are never touched, and nothing is sent to Discord.",
