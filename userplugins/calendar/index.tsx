            ...
            <div className={cl("note-header")}>
                ...
                <div className={cl("note-actions")}>
                    <button
                        ...
                        title={t("┘å╪│╪« ╪º┘ä╪╖╪º╪¿╪╣ ╪º┘ä╪▓┘à┘å┘è ┘ä╪»┘è╪│┘â┘ê╪▒╪»", "Copy Discord timestamp")}
                    >
                        <CopyIcon />
                    </button>
                    <button
                        ...
                        title={t("╪¡╪░┘ü ╪º┘ä┘à┘ä╪º╪¡╪╕╪⌐", "Delete note")}
                    >
                        <TrashIcon />
                    </button>
                </div>
    ...
    return (
        <div className={cl("add-form")}>
            <input
                ...
                placeholder={t("╪ú╪╢┘ü ┘à┘ä╪º╪¡╪╕╪⌐...", "Add a note...")}
                value={text}
    ...
    return (
        <ModalRoot {...props} size={ModalSize.LARGE} className={cl("modal-root")}>
            <ModalHeader className={cl("modal-header")}>
                <span className={cl("modal-title")}>{t("╪º┘ä╪¬┘é┘ê┘è┘à", "Calendar")}</span>
...
function CalendarButton() {
    return (
        <HeaderBarButton
            icon={CalendarIcon}
            tooltip={t("╪º┘ä╪¬┘é┘ê┘è┘à", "Calendar")}
