...
const settings = definePluginSettings({
    transitionDelay: {
        ...
        description: t("┘à╪»╪⌐ ╪º┘ä╪º┘å╪¬┘é╪º┘ä (┘à┘ä┘ä┘è ╪½╪º┘å┘è╪⌐)", "Transition delay (ms)"),
        default: 60,
        onChange: () => applyCSS(),
    },
    animationType: {
        type: OptionType.SELECT,
        description: t("┘å┘ê╪╣ ╪º┘ä╪¡╪▒┘â╪⌐", "Animation type"),
        options: [
    ...
    caretColor: {
        ...
        component: () => {
            ...
            return (
                <div>
                    <Forms.FormTitle tag="h3">{t("┘ä┘ê┘å ╪º┘ä┘à╪ñ╪┤┘æ╪▒", "Caret color")}</Forms.FormTitle>
