...
const TsundereTalkButton = ErrorBoundary.wrap(function TsundereTalkButton() {
    ...
    return (
        <HeaderBarButton
            ...
            tooltip={rewriteEnabled ? t("Tsundere Talk: ┘à┘Å┘ü╪╣┘æ┘ä", "Tsundere Talk: On") : t("Tsundere Talk: ┘à┘Å╪╣╪╖┘æ┘ä", "Tsundere Talk: Off")}
            aria-label={t("╪¬╪¿╪»┘è┘ä Tsundere Talk", "Toggle Tsundere Talk")}
