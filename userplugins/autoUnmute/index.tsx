...
const settings = definePluginSettings({
    warning: {
        ...
        component: () => <BanRiskWarning
            ar="╪¬╪¡╪░┘è╪▒: ╪º┘ä╪¬╪▒╪º╪¼╪╣ ╪¬┘ä┘é╪º╪ª┘è╪º┘ï ╪╣┘å ┘â╪¬┘à/╪Ñ╪╡┘à┘æ ╪º┘ä╪│┘è╪▒┘ü╪▒ ┘ä┘â = ┘à┘é╪º┘ê┘à╪⌐ ╪▒┘é╪º╪¿╪⌐ ╪º┘ä╪│┘è╪▒┘ü╪▒╪î ┘ê┘é╪» ┘è╪«╪º┘ä┘ü ┘é┘ê╪º╪╣╪»┘ç ╪ú┘ê ╪┤╪▒┘ê╪╖ ╪«╪»┘à╪⌐ Discord ┘ê┘è╪╣╪▒┘æ╪╢ ╪¡╪│╪º╪¿┘â ┘ä┘ä╪╖╪▒╪»/╪º┘ä╪¡╪╕╪▒. ┘è╪¬╪╖┘ä┘æ╪¿ ╪╡┘ä╪º╪¡┘è╪⌐ ┬½┘â╪¬┘à/╪Ñ╪╡┘à┘æ ╪º┘ä╪ú╪╣╪╢╪º╪í┬╗. ╪º╪│╪¬╪«╪»┘à┘ç╪º ╪¿┘à╪│╪ñ┘ê┘ä┘è╪⌐."
